...
This project predates the SPEC.md / ref/ redesign. Migrate manually:
  ...
  3. Create SPEC.md. The recommended path is `duplo init`, which
     generates SPEC.md for you. Alternatively, author one by hand
     using SPEC-template.md (in the duplo repository) as a starting
     point. If authoring by hand, at minimum fill in:
