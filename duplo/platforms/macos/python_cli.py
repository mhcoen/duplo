...
_PROFILE = PlatformProfile(
    ...
    planner_rules=[
        ...
        (
            ...
            "or .gitignore -- these are pre-generated by duplo. Phase 0 "
            "tasks should create the package directory with __init__.py "
            "and __main__.py, then run ./run.sh --help to verify the "
            "entry point works."
        ),
        (
